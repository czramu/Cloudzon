            ...
            <div class="opening">
              ...
              <div class="opening-main cf" id="part">-->
			   ...
			   <h2><?php echo $res['title'];?></h2>
                 <p><strong>Experience:<?php echo $res['experience'];?></strong></p>
				 <p><strong>Location:<?php echo $res['location'];?></strong></p>
                <p><strong class="part-btn">Job Description </strong>
			  </p>
					<!--<a href="career.php" class="open-btn">--><?php echo $res['jobdep'];?><!--</a>-->
			 </a>
			 <!-- </div>
			  </div>
			  </div>-->
